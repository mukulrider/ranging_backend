...
class npdpage_impact_forecast(APIView):
	def get(self, request, *args):
		...
		print(week)
		# args.pop('page__iexact',None)
		# args.pop('search__iexact',None)
		if week==None:
			week = 'Latest 13 Weeks'
		# apply_button = int(args.pop('apply_button__iexact',1))
		# print("apply button is ")
		# print(apply_button)

	#define variables 
		
		Buying_controller = args.pop('buying_controller__iexact', '')
		#global Buying_controller
		...
		#global Product_Sub_Group_Description
		...
		#global Till_Roll_Description
		Merchandise_Group_Description = args.pop('merchandise_group_code_description__iexact', '')
		print("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa")
		print(Merchandise_Group_Description)
		#global Merchandise_Group_Description
	...
	#files read
		...
		def get_priceband_psg_merch_code():
			...
			print("valueeeeeeeeeeeeeeeeeeeeeeeee")
			print(psg_code)
		...
		def psg_pb_prodcount(dataset):
			...
			return dataset
		# ### To isimncorporate merch grp and range class
		...
		def run_cannibilization_model(input_test_dataset,week_flag,time_frame):
			...
			# global PSGVolBrandBuckets
			# global PSGVolBuckets
			# global PSGBuckets
			# global brand_grp_mapping_df
			...
			print("lllllllllllllllllssssssssssssssssss")
			print(len(sim_prod_subset))
			if len(sim_prod_subset)>0:
				...
				print("bilkulllllllllllllll naiiiiiiiiiiiiiiiiiiiiiii")
		...
		def similar_product_cannabilized(time_frame):
			...
			# print(product_desc_branded.head())
		...
		print("check week for if condition")
		#global df
		...
		if week == 'Latest 13 Weeks':
			...
			if (len(sim_prod)) > 0:
				...
				# dataset.loc[:, 'no_of_subs_same_brand'] = 0
				# dataset.loc[:, 'no_of_subs_diff_brand'] = 0
		...
		# global similar_product
		print("ssssssssssssssssssssssssssssssssssssssssssssss")
		print(len(similar_product))
		print("search args")
		print(search)
		...
		print("after search")
		print(len(similar_product_final))
...
class npdpage_impact_edit_forecast(APIView):
	def get(self, request, *args):
		args = {reqobj + '__iexact': request.GET.get(reqobj) for reqobj in request.GET.keys()}
		# print(args)
		print(args)
		total_forecasted_volume = float(args.pop('modified_forecast__iexact',None))
		week_flag = args.pop('week_flag__iexact',None)

		global Product_Sub_Group_Description
		print(Product_Sub_Group_Description)
		global Cannibalization_perc
		print(Cannibalization_perc)
		global asp
		global All_attribute
		global product_contri_df
		global product_price_df
		...
		print("forecasted_cannibilization_volume")
		print(forecasted_cannibilization_volume)
		##### To get the cannibilized sales
		forecasted_cannibilization_volume = float(forecasted_cannibilization_volume)
